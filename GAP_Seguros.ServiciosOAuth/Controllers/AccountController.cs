...
using GAP_Seguros.ServiciosOAuth.Models;
using GAP_Seguros.ServiciosOAuth.Providers;
using GAP_Seguros.ServiciosOAuth.Results;

namespace GAP_Seguros.ServiciosOAuth.Controllers
{
    [Authorize]
